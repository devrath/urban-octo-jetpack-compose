...
import com.demo.onboarding_presentation.components.SelectableButton
...
fun GenderScreen(
    ...
    /**
     * Launch effect is needed to collect the events from the view model
     * We can listen to the changes in the coroutine
     * */
    LaunchedEffect(key1 = true) {
        viewModel.uiEvent.collect { event ->
            when (event) {
                // --> Navigate with the event
